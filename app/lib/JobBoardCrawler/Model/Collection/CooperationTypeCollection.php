<?php
namespace JobBoardCrawler\Model\Collection;
...
use JobBoardCrawler\Model\CooperationType;
...
class LocationCollection implements Countable, JsonSerializable, Iterator, ArrayAccess
{
    ...
    public function addItem(CooperationType $item)
    {
        $this->items[] = $item;
    }
    ...
    public function offsetSet($offset, $value)
    {
        if (!($value instanceof Location)) {
            throw new \InvalidArgumentException("Must be an instance of Location");
        }
